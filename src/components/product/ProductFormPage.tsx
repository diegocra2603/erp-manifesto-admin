...
import { AlertCircle, ArrowLeft, Save, BadgeCheck, FileText } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Card>
          <CardContent className="pt-6">
            <div className="mb-8">
              <h3 className="mb-1 text-base font-semibold text-foreground">Información del Producto</h3>
          ...
          <div className="flex justify-end gap-3 border-t border-border px-6 py-4">
            ...
            <Button
              ...
              size="large"
            >
              {isPending ? 'Guardando...' : isEditMode ? 'Actualizar Producto' : 'Crear Producto'}
            </Button>
          </div>
        </Card>
      </form>
