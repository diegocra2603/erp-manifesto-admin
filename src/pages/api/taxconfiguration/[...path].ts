/**
 * ============================================
 * API ENDPOINT - TAX CONFIGURATION BY ID & SUB-RESOURCES
 * ============================================
 * Handles: GET/PUT/DELETE /api/taxconfiguration/:id
 */
...
async function proxyRequest(method: string, backendPath: string, authHeader: string, body?: unknown) {
  ...
  const response = await fetch(`${API_URL}/api/TaxConfiguration/${backendPath}`, {
    method,
    headers,
