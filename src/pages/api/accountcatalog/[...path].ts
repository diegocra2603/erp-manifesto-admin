/**
 * ============================================
 * API ENDPOINT - ACCOUNT CATALOG BY ID & SUB-RESOURCES
 * ============================================
 * Handles: GET/PUT/DELETE /api/accountcatalog/:id
 */
...
async function proxyRequest(method: string, backendPath: string, authHeader: string, body?: unknown) {
  ...
  const response = await fetch(`${API_URL}/api/AccountCatalog/${backendPath}`, {
    method,
    headers,
