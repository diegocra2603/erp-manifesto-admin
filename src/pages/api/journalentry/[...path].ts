/**
 * ============================================
 * API ENDPOINT - JOURNAL ENTRY BY ID & SUB-RESOURCES
 * ============================================
 * Handles: GET/DELETE /api/journalentry/:id
 *          POST /api/journalentry/:id/approve
...
async function proxyRequest(method: string, backendPath: string, authHeader: string, body?: unknown) {
  ...
  const response = await fetch(`${API_URL}/api/JournalEntry/${backendPath}`, {
    method,
    headers,
