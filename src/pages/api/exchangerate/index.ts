/**
 * ============================================
 * API ENDPOINT - EXCHANGE RATES LIST & CREATE
 * ============================================
 */
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    const response = await fetch(`${API_URL}/api/ExchangeRate`, { method: 'GET', headers: { 'Authorization': authHeader, 'Accept': '*/*' }, signal: controller.signal });
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    const response = await fetch(`${API_URL}/api/ExchangeRate`, { method: 'POST', headers: { 'Authorization': authHeader, 'Content-Type': 'application/json', 'Accept': '*/*' }, body: JSON.stringify(body), signal: controller.signal });
    clearTimeout(timeoutId);
