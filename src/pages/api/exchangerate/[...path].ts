/**
 * ============================================
 * API ENDPOINT - EXCHANGE RATE BY ID & SUB-RESOURCES
 * ============================================
 * Handles: GET/PUT/DELETE /api/exchangerate/:id
 */
...
async function proxyRequest(method: string, backendPath: string, authHeader: string, body?: unknown) {
  ...
  const response = await fetch(`${API_URL}/api/ExchangeRate/${backendPath}`, {
    method,
    headers,
