/**
 * ============================================
 * API ENDPOINT - USERS LIST & CREATE
 * ============================================
 * Server-side endpoint for listing and creating users (JSON)
 */
...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    console.log('[POST /api/User] Body:', JSON.stringify(body));
    ...
    console.log('[POST /api/User] Response:', response.status, text);
